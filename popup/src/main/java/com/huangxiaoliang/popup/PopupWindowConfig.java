 ...
 */
public final class PopupWindowConfig extends BaseConfig<PopupWindowConfig, PopupWindowDelegate> {
    /**
    ...
    /**
     * PopupWindow窗口占满整个屏幕，忽略周围的装饰边框
     */
    private boolean mLayoutInScreen;

    /**
     * PopupWindow设置内容是否可超出屏幕外
     */
    ...
    /**
     * PopupWindow设置是否聚焦，为true时，cancelableOutside属性，返回键dismiss（cancelable属性无效）才会生效
     *
    ...
    /**
     * PopupWindow设置是否可触摸，为true时，内部View才可响应点击事件
     *
    ...
    /**
     * PopupWindow窗口是否占满整个屏幕，忽略周围的装饰边框
     *
    ...
    @Override
    public Popup<PopupWindowDelegate> create() {
        return new Popup<>(this, PopupWindowDelegate.class, PopupCompat.PopupWindow);
    }
}