package com.huangxiaoliang.popup.util;
...
import com.huangxiaoliang.popup.R;
...
public final class UIResHelper {
    ...
    public static int[] assignDialogActivityAnimWithAttr(Context context, int animStyle) {
        TypedArray a = context.obtainStyledAttributes(null, R.styleable.MTPopupDialogActivityAnimation, 0, animStyle);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.MTPopupDialogActivityAnimation_android_activityOpenEnterAnimation) {
                activityOpenEnterAnimation = a.getResourceId(attr, 0);
            } else if (attr == R.styleable.MTPopupDialogActivityAnimation_android_activityOpenExitAnimation) {
                activityOpenExitAnimation = a.getResourceId(attr, 0);
            } else if (attr == R.styleable.MTPopupDialogActivityAnimation_android_activityCloseEnterAnimation) {
                activityCloseEnterAnimation = a.getResourceId(attr, 0);
            } else if (attr == R.styleable.MTPopupDialogActivityAnimation_android_activityCloseExitAnimation) {
