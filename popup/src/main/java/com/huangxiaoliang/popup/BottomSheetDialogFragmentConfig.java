...
public final class BottomSheetDialogFragmentConfig
        extends BottomSheetBehaviorConfig<BottomSheetDialogFragmentConfig, BottomSheetDialogFragmentDelegate> implements Parcelable {
    ...
    @Override
    public Popup<BottomSheetDialogFragmentDelegate> create() {
        return new Popup<>(this, BottomSheetDialogFragmentDelegate.class, PopupCompat.BottomSheetDialogFragment);
    }
