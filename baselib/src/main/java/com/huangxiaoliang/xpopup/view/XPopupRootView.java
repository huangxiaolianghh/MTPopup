...
public final class XPopupRootView extends FrameLayout implements IDecorLayout {
    ...
    public XPopupRootView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public XPopupRootView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public XPopupRootView(Context context, AttributeSet attrs, int defStyleAttr) {
