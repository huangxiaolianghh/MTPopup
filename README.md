...
| mLifecycle<br>mPopupLifecycleObserver<br>mDismissObserverOnDestroy | observeOn(Lifecycle lifecycle, PopupLifecycleObserver popupLifecycleObserver)<br>observeOn(Lifecycle lifecycle, boolean dismissObserverOnDestroy) | 被观察者生命周期的回调<br>设置onDestroy()回调关闭Popup的开关 |
...
<a href="https://blog.csdn.net/HHHceo/article/details/124658074">MTPopup，Android一个简单强大的弹框</a>
